  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_text = function() {
      if (this.form_field.getAttribute("data-placeholder")) {
        ...
        this.default_text = this.options.placeholder_text_multiple || this.options.placeholder_text || "Selecione algumas opcoes";
      } else {
        this.default_text = this.options.placeholder_text_single || this.options.placeholder_text || "Selecione";
      }
      return this.results_none_found = this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || "Nao rolou, tenta de novo" ;
    };
...
(function ($) {
  ...
  $.fn.ajaxChosen = function (options, chosenOptions) {
    var select = $(this),
        chosen,
        keyRight,
        input,
    ...
    ajaxOptions.success = function (data, textStatus, jqXHR) {
      ...
      if ($.isArray(items)) {
        ...
        $.each(items, function (i, opt) {
          $('<option  value="' + opt._id + '">' + opt.nm_titu + '</option>').appendTo(select).data("prod_det", opt);
        });
      } else {
        //hash of kv pairs {'id':'text'...}
        $.each(items, function (value, text) {
          $('<option value="' + value + '">' + nm_titu + '</option>').appendTo(select);
        });
      }
      //update chosen
    ...
    $('.chzn-search > input, .chzn-choices .search-field input', chosen).bind('keyup', function (e) {
      ...
      //dynamically generate url on url option
      if ('generateUrl' in options && $.isFunction(options.generateUrl)) {
        ajaxOptions.url = options.generateUrl.call(this);
      }
